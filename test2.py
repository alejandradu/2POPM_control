...
nidaq = MAIN2.nidaq(
            ...
            z_end = 170.0,                            # ASSUMING 175 nm = 20 deg
            num_z_slices = 10,                       # TODO: is it more useful to have a step or a number of slices?
...
# stack_trigger = nidaq._stack_trigger()
# exp_trigger = nidaq._cam_exposure_trigger()
...
# # set multi_d = True, z_slices = 10, z_start & end 0 to 100 as a proxy CLARIFY UNITS (or put voltage directly)
# print("stack time: ", nidaq.get_stack_time())
# print("acq time: ", nidaq.get_total_acq_time())


# # 4. Test stack trigger with galvo waveform
# # connect second channel of oscilloscope to ao0 output
# stack_trigger = nidaq._stack_trigger()
# task_galvo = nidaq._create_ao_task()
# data_galvo = nidaq._get_ao_galvo_data()
# task_galvo.timing.cfg_samp_clk_timing(rate=nidaq.stack_sampling_rate, sample_mode=nidaqmx.constants.AcquisitionType.FINITE, 
